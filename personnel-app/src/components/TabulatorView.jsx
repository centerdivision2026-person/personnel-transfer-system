...
const RANK_LIST = [
  ...
  'ร.ต.','ร.ท.','ร.อ.',
  'น.ต.','น.ท.','น.อ.',
  'พ.ต.','พ.ท.','พ.อ.','พ.อ.(พ)','น.อ.(พ)','น.อ.อ.(พ)',
  'พล.ต.','พล.ท.','พล.อ.',
...
const RANK_TO_SALARY = {
  // ป.1 — ส.ต. ถึง ส.อ.
  'ส.ต.': 'ป.1', 'ส.ท.': 'ป.1', 'ส.อ.': 'ป.1',
  'จ.ต.': 'ป.1', 'จ.ท.': 'ป.1', 'จ.อ.': 'ป.1',
  // ป.2 — จ.ส.ต. ถึง จ.ส.อ.
  'จ.ส.ต.': 'ป.2', 'จ.ส.ท.': 'ป.2', 'จ.ส.อ.': 'ป.2',
  // ป.3 — จ.ส.อ.(พ)
  'จ.ส.อ.(พ)': 'ป.3',
  // น.1 — ร.ต. ถึง ร.อ.
  'ร.ต.': 'น.1', 'ร.ท.': 'น.1', 'ร.อ.': 'น.1',
  // น.2 — พ.ต. / น.ต.
  'พ.ต.': 'น.2', 'น.ต.': 'น.2',
  // น.3 — พ.ท. / น.ท.
  'พ.ท.': 'น.3', 'น.ท.': 'น.3',
  // น.4 — พ.อ. / น.อ.
  'พ.อ.': 'น.4', 'น.อ.': 'น.4',
  // น.5 — พ.อ.(พ) / น.อ.(พ) / น.อ.อ.(พ) ทั้ง 3 เหล่าทัพ
  'พ.อ.(พ)': 'น.5', 'น.อ.(พ)': 'น.5', 'น.อ.อ.(พ)': 'น.5',
  // น.6 — พล.ต. / พล.ร.ต. / พล.อ.ต.
  'พล.ต.': 'น.6', 'พล.ร.ต.': 'น.6', 'พล.อ.ต.': 'น.6',
  // น.7 — พล.ท. / พล.อ. / พล.ร.ท. / พล.ร.อ. / พล.อ.ท. / พล.อ.อ.
  'พล.ท.': 'น.7', 'พล.ร.ท.': 'น.7', 'พล.อ.ท.': 'น.7',
  'พล.อ.': 'น.7', 'พล.ร.อ.': 'น.7', 'พล.อ.อ.': 'น.7',
  // ประจำ
